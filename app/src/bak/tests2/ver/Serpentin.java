...
public class Serpentin extends TestObjetSub {
    ...
    public void ginit() {
        try {
            ...
            itext = new TextureCol(Color.valueOf(0,0,1));
        }

        LumierePonctuelle lumierePonctuelle = new LumierePonctuelle(Point3D.X, Color.valueOf(1,0,0));
        lumierePonctuelle.setR0(1);

        scene().lumieres().add(lumierePonctuelle);

        lumierePonctuelle = new LumierePonctuelle(Point3D.Y, Color.valueOf(0,1,0));
        lumierePonctuelle.setR0(1);
        ...
        scene().lumieres().add(new LumierePonctuelle(Point3D.O0, Color.valueOf(1,1,1)));
